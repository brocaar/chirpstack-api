...
_MULTICASTGROUPLISTITEM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='application_id', full_name='api.MulticastGroupListItem.application_id', index=3,
