...
interface IApplicationServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  createInfluxDBV2Integration: grpc.MethodDefinition<as_external_api_application_pb.CreateInfluxDBV2IntegrationRequest, google_protobuf_empty_pb.Empty>;
  getInfluxDBV2Integration: grpc.MethodDefinition<as_external_api_application_pb.GetInfluxDBV2IntegrationRequest, as_external_api_application_pb.GetInfluxDBV2IntegrationResponse>;
  updateInfluxDBV2Integration: grpc.MethodDefinition<as_external_api_application_pb.UpdateInfluxDBV2IntegrationRequest, google_protobuf_empty_pb.Empty>;
  deleteInfluxDBV2Integration: grpc.MethodDefinition<as_external_api_application_pb.DeleteInfluxDBV2IntegrationRequest, google_protobuf_empty_pb.Empty>;
...
export interface IApplicationServiceServer extends grpc.UntypedServiceImplementation {
  ...
  createInfluxDBV2Integration: grpc.handleUnaryCall<as_external_api_application_pb.CreateInfluxDBV2IntegrationRequest, google_protobuf_empty_pb.Empty>;
  getInfluxDBV2Integration: grpc.handleUnaryCall<as_external_api_application_pb.GetInfluxDBV2IntegrationRequest, as_external_api_application_pb.GetInfluxDBV2IntegrationResponse>;
  updateInfluxDBV2Integration: grpc.handleUnaryCall<as_external_api_application_pb.UpdateInfluxDBV2IntegrationRequest, google_protobuf_empty_pb.Empty>;
  deleteInfluxDBV2Integration: grpc.handleUnaryCall<as_external_api_application_pb.DeleteInfluxDBV2IntegrationRequest, google_protobuf_empty_pb.Empty>;
...
export class ApplicationServiceClient extends grpc.Client {
  ...
  createInfluxDBV2Integration(argument: as_external_api_application_pb.CreateInfluxDBV2IntegrationRequest, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  createInfluxDBV2Integration(argument: as_external_api_application_pb.CreateInfluxDBV2IntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  createInfluxDBV2Integration(argument: as_external_api_application_pb.CreateInfluxDBV2IntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  getInfluxDBV2Integration(argument: as_external_api_application_pb.GetInfluxDBV2IntegrationRequest, callback: grpc.requestCallback<as_external_api_application_pb.GetInfluxDBV2IntegrationResponse>): grpc.ClientUnaryCall;
  getInfluxDBV2Integration(argument: as_external_api_application_pb.GetInfluxDBV2IntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<as_external_api_application_pb.GetInfluxDBV2IntegrationResponse>): grpc.ClientUnaryCall;
  getInfluxDBV2Integration(argument: as_external_api_application_pb.GetInfluxDBV2IntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<as_external_api_application_pb.GetInfluxDBV2IntegrationResponse>): grpc.ClientUnaryCall;
  updateInfluxDBV2Integration(argument: as_external_api_application_pb.UpdateInfluxDBV2IntegrationRequest, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  updateInfluxDBV2Integration(argument: as_external_api_application_pb.UpdateInfluxDBV2IntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  updateInfluxDBV2Integration(argument: as_external_api_application_pb.UpdateInfluxDBV2IntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  deleteInfluxDBV2Integration(argument: as_external_api_application_pb.DeleteInfluxDBV2IntegrationRequest, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  deleteInfluxDBV2Integration(argument: as_external_api_application_pb.DeleteInfluxDBV2IntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  deleteInfluxDBV2Integration(argument: as_external_api_application_pb.DeleteInfluxDBV2IntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
