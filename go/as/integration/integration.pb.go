...
// TxEvent is the message sent when a downlink was acknowledged by the gateway
...
func (m *TxEvent) GetApplicationId() uint64 {
	if m != nil {
		return m.ApplicationId
	}
	return 0
...
func (m *TxEvent) GetApplicationName() string {
	if m != nil {
		return m.ApplicationName
	}
	return ""
...
func (m *TxEvent) GetDeviceName() string {
	if m != nil {
		return m.DeviceName
	}
	return ""
...
func (m *TxEvent) GetTags() map[string]string {
	if m != nil {
		return m.Tags
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TxEvent)(nil), "integration.TxEvent")
	proto.RegisterMapType((map[string]string)(nil), "integration.TxEvent.TagsEntry")
...
var fileDescriptor_5ba82681be587591 = []byte{
	...
	,
}
